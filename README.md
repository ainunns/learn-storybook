...
1.  **Browse your stories!**
    ...
    Run `pnpm run storybook` to see your component's stories at `http://localhost:6006`
...
10. **`pnpm-lock.yaml`**: This is an automatically generated file based on the exact versions of your npm dependencies that were installed for your project. **(Do not change it manually).**
